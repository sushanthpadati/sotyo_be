...
currentmedication_block_routes = Blueprint('currentmedication_block_routes', __name__)

@currentmedication_block_routes.route('/currentmedication_block_option', methods=['POST'])
